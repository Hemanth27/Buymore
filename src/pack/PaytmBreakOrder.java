	...
	public static void main(String[] args) {
		...
		*/
		...
		vendor_price=sc.nextDouble();
	  	 	...
	  	 	PaytmBreakOrder order=new PaytmBreakOrder();
	  	 	order.paytm();
	}
	
	public void paytm()
	{
      double break_even=((incoming_price+weight_handling_charge+pick_pack_value)*hsn_rate)/(1-(((commission_rate+2)/100)*hsn_rate));
