...
public class Refunds {
	...
	static double display_price, payable_amount,buymore_commission,amazon_commission,portal_deduction_one;
	...
	public static void main(String[] args) {
		...
		//Portal Deduction = display price-(amazon commission+buymore commission)
		
		/*portal_deduction_one=(display_price-(amazon_commission+buymore_commission));
		System.out.println("Refunds : "+ portal_deduction_one);*/
		
		double difference=display_price-amazon_commission;
		System.out.println("Commission on Return :" +difference);
}
}
