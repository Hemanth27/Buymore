...
public class Flipkart {
	...
	static int min_per,max_per,pick_pack_value, fixed;
	...
	public static void main(String[] args) {
		...
		vendor_price=sc.nextDouble();
	  	...
	  	double break_even=((incoming_price+weight_handling_charge+pick_pack_value+fixed+15)*hsn_rate_value)/(1-(((commission_rate+2)/100)*hsn_rate_value));
	  ...
	  System.out.println("Break Even Selling Price" +break_even);
	  	...
	  	if(break_even>750)
	  	{
	  		double break_even1=((incoming_price+weight_handling_charge+pick_pack_value+fixed)*hsn_rate_value)/(1-(((commission_rate+2+2)/100)*hsn_rate_value));
	  		System.out.println(break_even1);
	  		if(min_per<0)
		  	{
